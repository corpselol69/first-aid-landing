  ...
  return (
    <section className="section">
      <div className="container">
        <h2 className="font-display text-brand text-2xl md:text-5xl uppercase">
          три основных блока
        </h2>
        <div className="mt-12 space-y-12 text-white">
          <p className="font-display text-xl md:text-4xl w-full ">
          ...
          <p className="font-display leading-[200%] w-full text-xl md:text-4xl">
            <span className="text-danger font-bold">+ </span>
            <span className=" font-bold md:text-4xl">НАВЫКИ. </span>
          ...
          <p className="font-display leading-[200%] w-full text-xl md:text-4xl">
            <span className="text-danger font-bold">+ </span>
            <span className=" font-bold md:text-4xl">АПТЕЧКА. </span>
            <span className="font-light leading-[200%]">
