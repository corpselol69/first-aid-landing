    ...
    <section className="section relative overflow-visible">
      <div className="container relative">
        ...
        <div className="mt-8 grid gap-[4rem]">
          ...
          >
            ...
            <div className="text-center">
              <div className="font-bold font-sans text-[56px] leading-none text-xl md:text-[128px] text-white ">
                RuStore
              </div>
            </div>
          </a>
          ...
          <div className="flex flex-col items-center gap-3 w-full">
            ...
            >
              ...
              <div className="flex items-center justify-center gap-4">
                <div className="text-center">
                  ...
                  <div className="flex items-center justify-center gap-3 text-white/90 text-l md:text-3xl font-display font-extralight mt-2">
                    <img src={android} alt="Android" className="h-8 w-8" />
                    оффлайн версия
                  </div>
                </div>
              </div>
            ...
            <div className="flex items-center justify-center text-l md:text-3xl font-light">
              <img src={mark} alt="Android" className="h-8 w-8" />
          ...
          >
            ...
            <div className="flex items-center justify-center gap-4">
              <div className="text-center">
                <div className="font-sans font-bold text-white text-xl md:text-[96px] leading-none">
                  ВЕБ версия
                </div>
                <div className="flex items-center justify-center gap-3 text-white/90 text-l font-extralight md:text-2xl font-display lowercase mt-2">
                  <img src={laptop} alt="Web" className="h-8 w-8" />
                  экспериментальная
                </div>
              </div>
            </div>
        ...
        <div className="mt-6 flex flex-col items-center gap-2 text-white">
          <div className="text-white text-l md:text-3xl text-center leading-snug md:leading-tight font-light">
