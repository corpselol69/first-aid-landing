...
export function Testimonials() {
  ...
  const items = data ?? [
    { id: 1, author: 'Иван', text: 'Отличное приложение — всё понятно и оффлайн!' },
    { id: 2, author: 'Мария', text: 'Помогло в дороге, спасибо за алгоритмы.' },
    { id: 3, author: 'Алексей', text: 'Минималистично и быстро, нашёл всё нужное.' },
      ...
      <div className="container">
        ...
        <div className="mt-4 embla" ref={emblaRef}>
          <div className="embla__container">
            {items.map((t) => (
              <div key={t.id} className="embla__slide pr-4 sm:basis-1/2 lg:basis-1/3">
